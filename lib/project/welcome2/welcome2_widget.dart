...
class Welcome2Widget extends StatefulWidget {
  const Welcome2Widget({Key? key}) : super(key: key);
...
class _Welcome2WidgetState extends State<Welcome2Widget>
  ...
  Future<void> _playOpeningSound() async {
    try {
      await _audioPlayer.setAsset('assets/audios/welcome2.mp3');
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFF334E53), Color(0xFF93DF46)],
                    stops: [0.0, 1.0],
                  ...
                  child: Column(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Image.network(
                          'https://firebasestorage.googleapis.com/v0/b/bank-app-bcb6e.appspot.com/o/scan.jpg?alt=media&token=e8487194-d1b4-4e88-97ed-7fefdf135990',
                          width: 300,
                          height: 300,
                          fit: BoxFit.cover,
                        ),
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            44.0, 8.0, 44.0, 0.0),
                        child: Text(
                          'สามารถเก็บประวัติการสแกนได้ และมีระบบช่วยเหลือAccessibility Vibration',
