...
import 'package:bank/manual/manual_widget.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => Welcome1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => Welcome1Widget(),
        ),
        FFRoute(
          name: 'welcome1',
          path: '/welcome1',
        ...
        FFRoute(
          ...
          path: '/scanhistory',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'scanhistory')
              : ScanhistoryWidget(),
        ),
        FFRoute(
          name: 'scan',
